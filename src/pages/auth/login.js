...
const Login = () => {
  ...
  return (
    <AuthLayout>
      <Meta
        title="Login | AI Toolbox™ - Simplify Workflows & Accelerate Growth"
        description="Login to AI Toolbox to streamline your business workflows, automate tasks, and scale faster with AI-powered tools."
      />
